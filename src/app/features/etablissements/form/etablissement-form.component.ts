...
@Component({
  ...
  template: `
    <div class="page-header">
      <h1>{{ (isEdit ? 'ETABLISSEMENT.FORM.TITLE_EDIT' : 'ETABLISSEMENT.FORM.TITLE_ADD') | translate }}</h1>
    ...
    <form [formGroup]="form" (ngSubmit)="onSubmit()" *ngIf="!loading">
      ...
      <mat-card class="mb-2">
        <mat-card-header><mat-card-title>{{ 'ETABLISSEMENT.DETAIL.SECTION_IDENTIFICATION' | translate }}</mat-card-title></mat-card-header>
        <mat-card-content>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.NOM_FR_LABEL' | translate }}</label>
              <input type="text" formControlName="nomFr" [placeholder]="'ETABLISSEMENT.FORM.NOM_FR_PLACEHOLDER' | translate">
              <span class="err" *ngIf="form.get('nomFr')?.invalid && form.get('nomFr')?.touched">{{ 'ETABLISSEMENT.FORM.REQUIRED' | translate }}</span>
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.NOM_AR_LABEL' | translate }}</label>
            ...
            <div class="field">
              <label>{{ 'ETABLISSEMENT.CODE' | translate }}</label>
              <input type="text" formControlName="code" [placeholder]="'ETABLISSEMENT.CODE' | translate">
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.TELEPHONE' | translate }}</label>
              <input type="text" formControlName="telephone" placeholder="0600000000">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FAX' | translate }}</label>
              <input type="text" formControlName="fax" [placeholder]="'ETABLISSEMENT.FAX' | translate">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.ADRESSE' | translate }}</label>
              <input type="text" formControlName="adresse" [placeholder]="'ETABLISSEMENT.ADRESSE' | translate">
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.PERSONNE_RESPONSABLE' | translate }}</label>
              <select formControlName="personneResponsableCentre">
                <option value="">{{ 'ETABLISSEMENT.FORM.SELECT_PLACEHOLDER' | translate }}</option>
          ...
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.UTILISATION' | translate }}</label>
              <select formControlName="utilisation">
                <option value="">{{ 'ETABLISSEMENT.FORM.SELECT_PLACEHOLDER' | translate }}</option>
                <option value="utilisé">{{ 'ETABLISSEMENT.FORM.UTILISATION_UTILISE' | translate }}</option>
                <option value="non utilisé">{{ 'ETABLISSEMENT.FORM.UTILISATION_NON_UTILISE' | translate }}</option>
                <option value="partiellement utilisé">{{ 'ETABLISSEMENT.FORM.UTILISATION_PARTIEL' | translate }}</option>
              </select>
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.LOYER' | translate }}</label>
            ...
            <div class="field" *ngIf="form.get('loyer')?.value === 'true' || form.get('loyer')?.value === true">
              <label>{{ 'ETABLISSEMENT.FORM.QUI_PAIE_LOYER' | translate }}</label>
              <input type="text" formControlName="paieLoyer" [placeholder]="'ETABLISSEMENT.FORM.QUI_PAIE_LOYER' | translate">
            </div>
          </div>
          <div class="form-row" *ngIf="form.get('loyer')?.value === 'true' || form.get('loyer')?.value === true">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.MONTANT_LOYER_LABEL' | translate }}</label>
              <input type="number" formControlName="montantLoyer" placeholder="0">
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.ETAT_CONSTRUCTION_LABEL' | translate }}</label>
              <select formControlName="etatConstruction">
                <option value="">{{ 'ETABLISSEMENT.FORM.SELECT_PLACEHOLDER' | translate }}</option>
                <option value="Bon">{{ 'ETABLISSEMENT.FORM.ETAT_BON' | translate }}</option>
                <option value="Moyen">{{ 'ETABLISSEMENT.FORM.ETAT_MOYEN' | translate }}</option>
                <option value="Mauvais">{{ 'ETABLISSEMENT.FORM.ETAT_MAUVAIS' | translate }}</option>
              </select>
            </div>
          </div>
        </mat-card-content>
      ...
      <mat-card class="mb-2">
        <mat-card-header><mat-card-title>{{ 'ETABLISSEMENT.DETAIL.SECTION_LOCALISATION' | translate }}</mat-card-title></mat-card-header>
        <mat-card-content>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.REGION' | translate }}</label>
            ...
            <div class="field">
              ...
              <span class="err" *ngIf="form.get('provinceId')?.invalid && form.get('provinceId')?.touched">{{ 'ETABLISSEMENT.FORM.REQUIRED' | translate }}</span>
            </div>
          </div>
          <div class="coords-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.LAT_LABEL' | translate }}</label>
              <input type="number" formControlName="latitude" placeholder="ex: 33.589" (change)="updateMarker()">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.LNG_LABEL' | translate }}</label>
            ...
            <button type="button" class="btn btn-outline" (click)="locateMe()">
              <mat-icon>my_location</mat-icon> {{ 'ETABLISSEMENT.FORM.MY_LOCATION' | translate }}
            </button>
          </div>
          <div class="map-hint">
            <mat-icon>info_outline</mat-icon>
            {{ 'ETABLISSEMENT.FORM.MAP_HINT' | translate }}
          </div>
      ...
      <mat-card class="mb-2">
        <mat-card-header><mat-card-title>{{ 'ETABLISSEMENT.DETAIL.TAB_TECH' | translate }}</mat-card-title></mat-card-header>
        <mat-card-content>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.PROPRIETE_LABEL' | translate }}</label>
              <select formControlName="proprietecentre">
                <option value="">{{ 'ETABLISSEMENT.FORM.SELECT_PLACEHOLDER' | translate }}</option>
                <option value="ENTRAIDE">{{ 'ETABLISSEMENT.FORM.PROPRIETE_ENTRAIDE' | translate }}</option>
                <option value="COMMUNE">{{ 'ETABLISSEMENT.FORM.PROPRIETE_COMMUNE' | translate }}</option>
                <option value="DOMAINE">{{ 'ETABLISSEMENT.FORM.PROPRIETE_DOMAINE' | translate }}</option>
                <option value="ASSOCIATION">{{ 'ETABLISSEMENT.FORM.PROPRIETE_ASSOCIATION' | translate }}</option>
                <option value="AUTRE">{{ 'ETABLISSEMENT.FORM.PROPRIETE_AUTRE' | translate }}</option>
              </select>
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.NUMERO_TITRE' | translate }}</label>
              <input type="text" formControlName="numerotitre" [placeholder]="'ETABLISSEMENT.DETAIL.NUMERO_TITRE' | translate">
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.DATE_ACHAT' | translate }}</label>
              <input type="date" formControlName="dateAchat">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.DATE_EXPLOITATION' | translate }}</label>
              <input type="date" formControlName="dateExploitation">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.DATE_CONSTRUCTION' | translate }}</label>
              <input type="date" formControlName="dateConstruction">
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.SUPERFICIE_TERRAIN' | translate }} (m²)</label>
              <input type="number" formControlName="superficieTerrain" placeholder="0">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.SURFACE_BATIE' | translate }} (m²)</label>
              <input type="number" formControlName="surfaceBatie" placeholder="0">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.SUPERFICIE_ETAGES' | translate }} (m²)</label>
              <input type="number" formControlName="superficieTotaleEtages" placeholder="0">
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.NOMBRE_ETAGES' | translate }}</label>
              <select formControlName="nombreEtage">
                <option value="">{{ 'ETABLISSEMENT.FORM.SELECT_PLACEHOLDER' | translate }}</option>
                <option value="0">{{ 'ETABLISSEMENT.FORM.ETAGE_SOUS_SOL' | translate }}</option>
                <option value="1">{{ 'ETABLISSEMENT.FORM.ETAGE_1' | translate }}</option>
                <option value="2">{{ 'ETABLISSEMENT.FORM.ETAGE_2' | translate }}</option>
                <option value="3">{{ 'ETABLISSEMENT.FORM.ETAGE_3' | translate }}</option>
                <option value="4">{{ 'ETABLISSEMENT.FORM.ETAGE_4' | translate }}</option>
                <option value="5">{{ 'ETABLISSEMENT.FORM.ETAGE_5' | translate }}</option>
              </select>
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.COMPOSANT_LABEL' | translate }}</label>
              <input type="text" formControlName="composant" [placeholder]="'ETABLISSEMENT.FORM.COMPOSANT_LABEL' | translate">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.ETAGES_UTILISES_LABEL' | translate }}</label>
              <input type="text" formControlName="etagesUtilises" [placeholder]="'ETABLISSEMENT.FORM.ETAGES_UTILISES_PLACEHOLDER' | translate">
            </div>
          </div>
          <div class="form-row">
            <div class="field" style="grid-column:span 3">
              <label>{{ 'ETABLISSEMENT.FORM.OBSERVATION_LABEL' | translate }}</label>
          ...
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.EAU_POTABLE' | translate }}</label>
            ...
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.ELECTRICITE' | translate }}</label>
          ...
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.PLAN_SITUATION_LABEL' | translate }}</label>
            ...
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.PLAN_ARCHITECTURE_LABEL' | translate }}</label>
            ...
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.LITIGE_LABEL' | translate }}</label>
          ...
          <div class="form-row" *ngIf="form.get('litige')?.value === 'true' || form.get('litige')?.value === true">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.RAISONS_CONFLIT_LABEL' | translate }}</label>
              <input type="text" formControlName="raisonsConflit" [placeholder]="'ETABLISSEMENT.FORM.RAISONS_CONFLIT_LABEL' | translate">
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.FORM.PRIX_BATIMENT_LABEL' | translate }}</label>
              <input type="number" formControlName="prixBatiment" placeholder="0">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.CAPACITE' | translate }}</label>
              <input type="number" formControlName="capaciteAccueil" placeholder="0">
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.GERE_PAR' | translate }}</label>
              <select formControlName="gererPar">
                <option value="">{{ 'ETABLISSEMENT.FORM.SELECT_PLACEHOLDER' | translate }}</option>
                <option value="EN">{{ 'ETABLISSEMENT.FORM.GERER_PAR_EN' | translate }}</option>
                <option value="ASSOCIATION">{{ 'ETABLISSEMENT.FORM.GERER_PAR_ASSOCIATION' | translate }}</option>
                <option value="AUTRE">{{ 'ETABLISSEMENT.FORM.GERER_PAR_AUTRE' | translate }}</option>
              </select>
            </div>
          </div>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.AUTORISE' | translate }}</label>
            ...
            <div class="field" *ngIf="form.get('autorise')?.value === 'true' || form.get('autorise')?.value === true">
              <label>{{ 'ETABLISSEMENT.DETAIL.NUMERO_AUTORISATION' | translate }}</label>
              <input type="text" formControlName="numeroAutorisation" [placeholder]="'ETABLISSEMENT.DETAIL.NUMERO_AUTORISATION' | translate">
            </div>
          </div>
        </mat-card-content>
      </mat-card>
      ...
      <!-- Section 4: Documents -->
      <mat-card class="mb-2">
        <mat-card-header><mat-card-title>{{ 'ETABLISSEMENT.DETAIL.TAB_DOCS' | translate }}</mat-card-title></mat-card-header>
        <mat-card-content>
          <div class="form-row">
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.DOC_MAPPE_CADASTRALE' | translate }}</label>
              <input type="file" (change)="onFileChange($event, 'mappeCadastrale')" style="padding:6px">
              <a *ngIf="existingFiles['mappeCadastrale']" [href]="getFileUrl(existingFiles['mappeCadastrale'])" target="_blank" class="file-link">{{ 'ETABLISSEMENT.FORM.VIEW_CURRENT_FILE' | translate }}</a>
            </div>
            <div class="field">
              <label>{{ 'ETABLISSEMENT.DETAIL.DOC_CERTIFICAT_PROPRIETE' | translate }}</label>
              <input type="file" (change)="onFileChange($event, 'certificatPropriete')" style="padding:6px">
              <a *ngIf="existingFiles['certificatPropriete']" [href]="getFileUrl(existingFiles['certificatPropriete'])" target="_blank" class="file-link">{{ 'ETABLISSEMENT.FORM.VIEW_CURRENT_FILE' | translate }}</a>
            </div>
          </div>
        </mat-card-content>
      </mat-card>
      ...
      <mat-card class="mb-2">
        <mat-card-header><mat-card-title>{{ 'ETABLISSEMENT.FORM.SECTION_PROGRAMMES' | translate }}</mat-card-title></mat-card-header>
        <mat-card-content>
          <div class="form-row">
            <!-- Programmes checkboxes -->
            <div class="field">
              <label>{{ 'MENU.PROGRAMMES' | translate }}</label>
          ...
          <div *ngFor="let prog of selectedProgrammes" class="programme-prestations">
            <div class="prog-label">
              ...
              {{ prog.nomFr }} — {{ 'ETABLISSEMENT.FORM.PRESTATIONS_SUFFIX' | translate }}
            </div>
            <div class="prestations-grid">
              ...
              <span *ngIf="getPrestationsForProgramme(prog.id).length === 0" class="text-secondary" style="font-size:13px">
                {{ 'ETABLISSEMENT.FORM.NO_PRESTATIONS' | translate }}
              </span>
            </div>
          </div>

          <div *ngIf="selectedProgrammes.length === 0" class="text-secondary" style="font-size:13px;margin-top:8px">
            {{ 'ETABLISSEMENT.FORM.SELECT_PROGRAMME_HINT' | translate }}
          </div>
        </mat-card-content>
      </mat-card>
  ...
  onSubmit() {
    ...
    request.subscribe({
      next: (etab) => {
        ...
        this.snackBar.open(
          this.translate.instant(this.isEdit ? 'ETABLISSEMENT.FORM.UPDATED' : 'ETABLISSEMENT.FORM.CREATED'),
